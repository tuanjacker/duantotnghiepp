...
namespace DAL_PolyCafe
{
    public class DBUtil
    {
        public static string connString = @"Data Source=LAPTOP-9P3LS880\SQLEXPRESS;Initial Catalog=Xuong_QuanLyThuVien;Integrated Security=True;TrustServerCertificate=True";
